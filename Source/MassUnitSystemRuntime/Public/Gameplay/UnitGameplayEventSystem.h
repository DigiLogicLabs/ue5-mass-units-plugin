...
public:
    ...
    /** Register a listener and return the handle used for unregistration. */
    FDelegateHandle RegisterListener(FGameplayTag EventTag, FOnGameplayEvent::FDelegate Listener);
